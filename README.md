...
Get Firebase config and paste inside main.js firebaseConfig or create file name firebaseConfig and paste config there
Create Collection named "calls" in firebase store
